...
> Copy this file to `00_workspace/<unit>/working_files/progress/<handle>-<YYYY-MM-DD>.md` and fill it in.
...
|----------|------|------|---------|
| <name> | `00_workspace/<unit>/working_files/...` | dataset / model / report / diagram / code | <why it exists> |
